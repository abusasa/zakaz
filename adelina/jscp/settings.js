...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            { 
                image: './image/photos/b2.png', // Menggantikan fjr3qh.png (Index 2)
                content: 'С Днём рождения! Пусть каждый новый день приносит тебе счастье, вдохновение и приятные сюрпризы. Желаю, чтобы рядом всегда были любящие люди, а все мечты легко становились реальностью. Оставайся такой же красивой, доброй и невероятно очаровательной. 🌷' 
            },
            { 
                image: './image/photos/b3.png', // Menggantikan 8u5tf7.png (Index 3)
            },
            ...
            { 
                ...
                content: 'В этот особенный день хочу пожелать тебе море счастья, искренних улыбок и ярких эмоций. Пусть рядом всегда будут люди, которые любят и ценят тебя. Желаю исполнения самых заветных мечтаний и вдохновения на каждый новый день. Оставайся такой же прекрасной и неповторимой.' 
            }
        ]
    };
