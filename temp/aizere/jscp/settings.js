...
let settings = {
    ...
    sequence: 'Я ЛЮБЛЮ ТЕБЯ|МЕН СЕНІ ЖАҚСЫ КӨРЕМІН|I LOVE YOU| АЙЗЕРЕ❤',
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            { 
                image: './image/photos/b2.png', // Menggantikan fjr3qh.png (Index 2)
                content: 'кешырынызшы кешырынызшы' 
            },
            { 
                image: './image/photos/b3.png', // Menggantikan 8u5tf7.png (Index 3)
            },
            ...
            { 
                ...
                content: 'Я тебя люблю, и желаю чтобы ты всегда была счастлива! Айзере 💗' 
            }
        ]
    };
...
applySettingsButton.addEventListener('click', () => {
    ...
    settings.sequence = document.getElementById('sequenceText').value || 'FOR|AIZERE|❤';
