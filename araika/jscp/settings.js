...
let settings = {
    ...
    countdown: 3,
    matrixText: 'HAPPYWOMENS',
    matrixColor1: '#ff69b4', // Màu pink mẫu
    matrixColor2: '#ff1493', // Màu pink mẫu
    sequence: 'HAPPY|WOMENS|DAY|Я|Люблю|Тебя|Арайка|❤',
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            { 
                image: './image/photos/b2.png', // Menggantikan fjr3qh.png (Index 2)
                content: 'Я и не сомневался! Ты лучшая Арайка! 💗' 
            },
            { 
                image: './image/photos/b3.png', // Menggantikan 8u5tf7.png (Index 3)
            },
            ...
            { 
                ...
                content: 'Ты сегодня сделала меня самым счастливым человеком на свете. Я люблю тебя, Арайка!' 
            }
        ]
    };
